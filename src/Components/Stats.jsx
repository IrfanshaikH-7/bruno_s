    ...
    <section className="main-container">
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-12 max-w-4xl mx-auto">
        ...
        <div className="relative bg-black/40 rounded-lg p-6 flex flex-col h-48 items-center justify-center overflow-hidden">
          ...
          <div className="absolute -top-20 -right-20 w-40 h-40 rounded-full bg-[#532959]/[38%] filter blur-[60px]"></div>
          ...
          <div className="relative z-10 flex items-baseline gap-2">
            ...
            <span className="text-2xl mb-5 ml-2 text-[#DFB6B2] font-afacad">
              38 reviews
            </span>
          </div>
        </div>
